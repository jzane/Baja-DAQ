...
{
public:
	Gage(int GageNumber); //constructor, takes pin to attach to gauge
...
void saveData(string entry, string filepath); //opens/closes file stream, creates file if dones't exist, takes care of naming files
